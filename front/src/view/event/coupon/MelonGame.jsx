...
import tmImg1 from './tm1.png';
import tmImg2 from './tm2.png';
import tmImg3 from './tm3.png';
import tmImg4 from './tm4.png';
import tmImg5 from './tm5.png';
import tmImg6 from './tm6.png';
import tmImg7 from './tm7.png';
import tmImg8 from './tm8.png';
import tmImg9 from './tm9.png';
import tmImg_score from './tm_score.png';
import tmT from './tm_t.png';
import tmMain from './mainMelon.png';
import bsbgm from './bgm.mp3';
import bbyong_sound from './bbyong.mp3';
import endbgm from './endbgm.mp3';
import Faded from '../../../effect/Faded';
import '../../../css/melon.css';
  ...
  function test() {
    ...
    function timeF()
    {
        ...
        //   db.collection("score").add({name:userName, score: cnt});
            ...
            ct=1;
            if(user)
                axios.get(`${serverIP.ip}/event/melonRank?score=${cnt}`,{
    ...
    return (
      ...
      <div id='melon-wrap'>
        ...
        <button style={startButtonStyle} id="startButton" onClick={test}>시작하기</button>
        <button id="exitButton" style={exitButtonStyle} onClick={test2}>홈으로</button>
        <button id="exitButton2" style={exitButtonStyle2} onClick={goHome}>홈으로</button>
      </div>
      </Faded>
    );
}
